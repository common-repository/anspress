...
add_action('ap_page_top', 'ap_warning');
function ap_warning(){
	if(is_super_admin()){
	?>
		<div class="moved-anspress">We have moved AnsPress repository, please reinstall it from here <a href="https://wordpress.org/plugins/anspress-question-answer/">https://wordpress.org/plugins/anspress-question-answer/</a>
		<h3>How to re-install ?</h3>
		<p>
			Simply go to wp-admin->plugins and deactivate AnsPress and delete files. or do it manually go to wp-content/plugins/ and remove anspress directory.<br>
			And then reinstall form given URL.
		</p>
		<p>NOTE: Reinstalling will not cause any data loss. So, do not worry.</p>
		</div>
	<?php
	}
}